...
{
    [EnableCors("*", "*", "*")]
    public class StGuController : ApiController
    {
        [HttpGet]
        [Route("api/stGu")]
        ...
        public HttpResponseMessage Get(int id)
        {
            try
            {
                ...
                return Request.CreateResponse(HttpStatusCode.OK, StGuService.Get(id));
            }
            catch (Exception ex)
            {
        ...
        public HttpResponseMessage Add(StGuTeDTO obj)
        {
            try
            {
                var res = StGuService.Create(obj);
                if (res)
                {
        ...
        public HttpResponseMessage Update(StGuTeDTO obj)
        {
            try
            {
                var res = StGuService.Update(obj);
                if (res)
                {
        ...
        [HttpPost]
        [Route("api/stGu/delete/{id}")]
        public HttpResponseMessage Delete(int id)
        {
            try
            {

                return Request.CreateResponse(HttpStatusCode.OK, StGuService.Delete(id));
            }
            catch (Exception ex)
            {
